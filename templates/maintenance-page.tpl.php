  ...
  <div id="header" class="with-secondary-menu"><div class="section clearfix">
    ...
    <div id="main-wrapper"><div id="main" class="clearfix">
      <div id="content" class="column"><div class="section">
        ...
        <!-- Specific Friendly content depending on error -->
        <?php if (preg_match('/remaining connection slots are reserved/',$messages)): ?>
          <p>KnowPulse is experiencing higher than expected traffic. Please try back later.</p>
        <?php else: ?>
          <?php print $content; ?>
        <?php endif; ?>

        <!-- Original Error for administrator -->
        <?php if ($messages): ?>
