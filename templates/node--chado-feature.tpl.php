...
if($teaser) {
  ...
  elseif (in_array($node->feature->type_id->name, array('SNP'))) {
    $feature_type = 'variant';
    $feature_type_class = 'variant';
  }
  elseif (in_array($node->feature->type_id->name, array('contig'))) {
    $feature_type = 'sequence';
    $feature_type_class = 'sequence';
  }?>
