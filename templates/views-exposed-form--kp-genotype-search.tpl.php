...
<div class="views-exposed-form">
  <div class="views-exposed-widgets clearfix">
      ...
      <?php //***********************************
        $widget = $widgets['filter-add_germplasm_genotype'];
        unset($widgets['filter-add_germplasm_genotype']);
        $id = 'filter-add_germplasm_genotype';
      ?>
      ...
      <?php //***********************************
        $widget = $widgets['filter-polymorphic_germplasm'];
        unset($widgets['filter-polymorphic_germplasm']);
      ...
      ?>
      <div id="<?php print $widget->id; ?>-wrapper" class="views-exposed-widget views-widget-<?php print $id; ?> <?php print $poly_class?>">
        <?php if (!empty($widget->label)): ?>
          <label for="<?php print $widget->id; ?>">
            <?php print $widget->label; ?>
          </label>
